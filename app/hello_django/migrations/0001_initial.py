# Generated by Django 4.2.3 on 2024-04-03 08:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting', 'En attente de joueurs'), ('end_game', 'Fin de tournoi'), ('in_game', 'En jeu'), ('cancel', 'Annulé')], default='waiting', max_length=20)),
                ...
                ('player02', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='player02_tournaments', to='hello_django.user_list')),
                ('player03', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='player03_tournaments', to='hello_django.user_list')),
                ('player04', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='player04_tournaments', to='hello_django.user_list')),
                ('player_winner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='winner_matches_tournaments', to='hello_django.user_list')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting', 'En attente de joueurs'), ('end_game', 'Fin de partie'), ('in_game', 'En jeu'), ('cancel', 'Annulé')], default='waiting', max_length=20)),
                ...
                ('player_winner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='winner_matches', to='hello_django.user_list')),
            ],
        ),
        migrations.CreateModel(
            name='Friendship',
